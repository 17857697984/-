...
@WebServlet("/bzdfServlet")
public class BzdfServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for(int i = 1;i<=19;i++)
        {
            ...
            double bzf = playerMapper0.selectbzf(tmpid,tmpname);
            sqlsession.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        playerMapper.updatebzf(tmp.getId(),tmp.getFs(),tmpname);
        sqlsession.commit();
        sqlsession.close();
